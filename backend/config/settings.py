...
SECRET_KEY = 'django-insecure-(t=+@rf%h@b$7+w(56$31yktxn28p#e5-mf4g5^fq*1o)vy0#_'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # Add this line to include CORS middleware
]
